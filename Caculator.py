...
def btnClick(numbers):
 ...
 #   playsound("tit.wav",block=False)
    ...
    text_Input.set(operator)#textinput=operator de thuc hien buton
...
def btnEquals():
    global operator
 #   playsound("tit.wav",block=False)
    ketqua=str(eval(operator))
    text_Input.set(ketqua)
...
#hien thi va nhap du lieu tren man hinh
...
btEquals=Button(cal,padx=100,bd=8,fg="black",font=("arial",20,"bold"),text="=",command=btnEquals,bg="silver").grid(row=5,column=2,columnspan=2)
#btEquals=Button(cal,padx=95,bd=8,fg="black",font=("arial",20,"bold"),text="=",bg="silver").grid(row=5,column=2,columnspan=2)
#///////////////////////////////////
